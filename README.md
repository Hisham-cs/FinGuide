...
public class FinancialReport {
    ...
    public static void main(String[] args) {
        Report report = new Report("2024-01-01 to 2024-01-31","USD",newIncome(5000, 4000, 1000),
            new Expenses(3000, 1200, 800, 400, 200, 400),
            2000,
            2000
        );
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjM2MzI2NDUyLDM2MjUxMzk5MiwtMTQ3Nz
